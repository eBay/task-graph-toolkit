...
/**
 * Task for visiting a list of visitee objects.
 */
class MultiVisiteeVisitorWorkflowExecutor<T> implements IWorkflowExecutor<List<T>> {

    private final IVisiteeProvider<T> visiteeProvider;
    private final List<VisitorTask<T>> visitors;

    MultiVisiteeVisitorWorkflowExecutor(
