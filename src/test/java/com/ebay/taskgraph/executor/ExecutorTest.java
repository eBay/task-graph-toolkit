...
import com.ebay.taskgraph.service.Headers;
...
public class ExecutorTest {
    ...
    private static final CallableTaskConfig SYNC_TASK_CONFIG = new CallableTaskConfig(DIAGNOSTIC_CONFIG, CallableTaskConfig.ExecType.SYNC);
    private static final CallableTaskConfig SIMPLE_TASK_CONFIG = new CallableTaskConfig(DIAGNOSTIC_CONFIG, CallableTaskConfig.ExecType.SIMPLE);
    ...
    private static class TestAsyncDependency extends Task implements ICallableTask<Integer> {
        ...
        public Integer call() {
            try {
                ...
                CallableTaskConfig synctask = new CallableTaskConfig(DIAGNOSTIC_CONFIG, CallableTaskConfig.ExecType.SYNC);
